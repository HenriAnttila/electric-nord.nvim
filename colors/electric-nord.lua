...
hi("NormalFloat", { fg = c.snow1, bg = c.polar1 })
hi("FloatBorder", { fg = c.electric1, bg = c.polar1 })
hi("FloatTitle", { fg = c.electric1, bg = c.polar1, bold = true })
...
hi("SnacksPickerListCursorLine", { bg = c.polar1 })
...
hi("BufferLineBackground", { fg = c.aurora_blue, bg = c.polar0 })
hi("BufferLineBuffer", { fg = c.aurora_blue, bg = c.polar0 })
hi("BufferLineBufferSelected", { fg = c.snow2, bg = c.polar0, bold = true })
hi("BufferLineBufferVisible", { fg = c.snow0, bg = c.polar0 })
hi("BufferLineCloseButton", { fg = c.aurora_blue, bg = c.polar0 })
...
hi("BufferLineDuplicate", { fg = c.aurora_blue, bg = c.polar0 })
hi("BufferLineDuplicateSelected", { fg = c.snow0, bg = c.polar0 })
hi("BufferLineDuplicateVisible", { fg = c.aurora_blue, bg = c.polar0 })
hi("BufferLinePick", { fg = c.electric1, bg = c.polar0, bold = true })
hi("BufferLinePickSelected", { fg = c.electric1, bg = c.polar0, bold = true })
hi("BufferLinePickVisible", { fg = c.electric1, bg = c.polar0, bold = true })
